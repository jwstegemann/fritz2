...
//     * @return [List] of [ValidationMessage]s
//     */
//    actual fun validate(data: D, metadata: T): List<M> = validate(inspectorOf(data), metadata)
//
//    /**
...
//     */
//    fun isValid(data: D, metadata: T): Boolean = validate(inspectorOf(data), metadata)
