 ...
 */
fun <T, I> localStorageEntity(resource: LocalResource<T, I>): EntityRepository<T, I> =
    object : EntityRepository<T, I> {
        ...
        override suspend fun load(entity: T, id: I): T =
            window.localStorage["${resource.prefix}.${resource.serializeId(id)}"]?.let(resource.serializer::read)
                ?: entity
...
// * @param resource definition of the [LocalResource]
// */
//open class LocalStorageEntityRepository<T, I>(
 ...
 */
inline fun <T, I, Q> localStorageQuery(
    resource: LocalResource<T, I>,
    crossinline runQuery: (List<T>, Q) -> List<T> = { entities, _ -> entities }
) =
    object : QueryRepository<T, I, Q> {
...
//open class LocalStorageQueryRepository<T, I, Q>(
//    val resource: LocalResource<T, I>,
