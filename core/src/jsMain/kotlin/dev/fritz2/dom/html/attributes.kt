...
fun Tag<HTMLLabelElement>.`for`(value: String) = attr("htmlFor", value)
fun Tag<HTMLLabelElement>.`for`(value: Flow<String>) = attr("htmlFor", value)
...
fun Tag<HTMLScriptElement>.`for`(value: String) = attr("htmlFor", value)
fun Tag<HTMLScriptElement>.`for`(value: Flow<String>) = attr("htmlFor", value)
