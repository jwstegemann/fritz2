 ...
 * @property scope pass some arbitrary scope data into the [Tag]. (Default behaviour should be passing the parent
 *   instance down the DOM tree, see [registerSingle] and [registerMulti])
