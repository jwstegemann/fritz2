[fritz2](../../index.md) / [io.fritz2.dom.html](../index.md) / [Option](./index.md)
...
| [&lt;init&gt;](-init-.md) | Exposes the JavaScript [HTMLOptionElement](https://developer.mozilla.org/en/docs/Web/API/HTMLOptionElement) to Kotlin`Option()` |
