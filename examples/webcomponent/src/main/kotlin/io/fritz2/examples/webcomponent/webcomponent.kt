...
class WeatherCard : WebComponent<HTMLDivElement>() {
    //TODO: kann in ein initCallback das Shadow-Child zurückgibt, genau wie andere Lifecycles
    override fun loadCss(document: Document) = linkStylesheet(document, "./weathercard.css")
    //override fun loadCss(document: Document) = setStylesheet(document, """.weather-card { border: 1px solid red; }""")
