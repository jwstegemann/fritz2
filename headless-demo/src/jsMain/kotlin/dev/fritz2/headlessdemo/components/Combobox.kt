...
private fun RenderContext.demoCombobox(
    store: Store<Country?>,
...
fun RenderContext.comboboxDemo() {
    ...
    div("max-w-96 flex flex-col gap-4") {
        combine(
            ...
            demoCombobox(selectionStore, autoSelectMatch, openDropdownLazily, readOnlyStore.data)
        }
...
fun RenderContext.comboboxTestdrive() {
    div("space-y-4") {
        ...
        demoCard("With non-nullable selection Store") {
            val testId = "countries-nullable-mapped-store"
            ...
            demoCombobox(nullableStore, id = testId)
